...
public class CommunityVertex extends CommunityElement implements Vertex {
     ...
     */
    public CommunityVertex(final CommunityGraph graph, final Object id, final String label) {
     ...
     */
    public CommunityVertex(final CommunityGraph graph, final Object id, final String label, final Object... keyValues) {
        super((id == null) ? generateId() : id,
                (label == null) ? "vertex" : label,
                graph);
        this.properties = new HashMap<>();
    ...
    public <V> VertexProperty<V> property(VertexProperty.Cardinality cardinality, final String key, final V value, final Object... keyValues) {
        ...
        switch (cardinality) {
            case single:
                ...
                vertexProperty = new CommunityVertexProperty<>(generateId(), this, key, value, keyValues);
    ...
    public Iterator<Edge> edges(final Direction direction, final String... edgeLabels) {
        ...
        for (long handle : allEdgeHandles) {
            ...
            Edge edge = null;
            try {
                edge = (Edge) new CommunityEdge(graph, handle);
            } catch (Exception e) {
                continue;
            }
    ...
    public <V> VertexProperty<V> property(final String key, final V value) {
        ...
        final VertexProperty<V> newProp = new CommunityVertexProperty<>(generateId(), this, key, value);
