 ...
 */
public class LsmGraphClient {
    private static final Logger logger = LoggerFactory.getLogger(LsmGraphClient.class);
    ...
    private static void runTests(Client client) throws Exception {
        ...
        // Test completion
        logger.info("\n{}", "=".repeat(60));
        logger.info("All LsmGraph operations completed successfully!");
        logger.info("=".repeat(60));
    }
}