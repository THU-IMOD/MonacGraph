 ...
 */
public abstract class LsmElement implements Element {
    ...
    protected final LsmGraph graph;  // Parent graph instance
     ...
     * @param graph Parent LsmGraph instance
     */
    protected LsmElement(final Object id, final String label, final LsmGraph graph) {
