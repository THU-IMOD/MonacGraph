 ...
 */
public class LsmVertexProperty<V> extends LsmElement implements VertexProperty<V> {

    private Map<String, Property<?>> properties;  // Meta-properties cache (thread-safe)
    private final LsmVertex vertex;            // Parent vertex instance
    private final String key;                    // Property key
    private V value;                             // Property value
     ...
     */
    public LsmVertexProperty(final Object id, final LsmVertex vertex, final String key, final V value, final Object... propertyKeyValues) {
    ...
    public <U> Property<U> property(final String key, final U value) {
        ...
        final LsmProperty<U> property = new LsmProperty<>(this, key, value, graph);
        if (properties == null) {
